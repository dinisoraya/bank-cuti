                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-leavetype.php" class="btn btn-sm btn-success">Add New Leave Type</a></center>
                                    <table id="dataTable3" class="table table-hover table-striped text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit-leaveType.php?lid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" style="color:blue"></i></a>
