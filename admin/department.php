                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-department.php" class="btn btn-sm btn-success">Add New Department</a></center>
                                    ...
                                    {               ?>  
                                        <tr>
                                            ...
                                            <td><a href="edit-department.php?deptid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" style="color:blue"></i></a><a href="department.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <i class="fa fa-trash" style="color:red"></i></a></td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                    </table>
